...
const DistributionPreview = ({ data = [] }) => {
                  ...
                  {data.length > 0 ? (
                    data.map((distribution, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>{distribution.name || '_________________'}</TableCell>
                        <TableCell>{distribution.area || '_________________'}</TableCell>
                        <TableCell>{distribution.shift || '_________________'}</TableCell>
