                  ...
                  {data.length > 0 ? (
                    data.map((operation, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>{operation.type || '_________________'}</TableCell>
                        <TableCell>{operation.time || '_________________'}</TableCell>
                        <TableCell>{operation.area || '_________________'}</TableCell>
                        <TableCell>{operation.responsible || '_________________'}</TableCell>
                      </TableRow>
                    ))
                  ) : (
