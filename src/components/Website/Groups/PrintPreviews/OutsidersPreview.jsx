          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper} elevation={1}>
              <Table sx={{
                ...
                <TableBody>
                  {data.length > 0 ? (
                    data.map((outsider, index) => (
                      <TableRow key={index}>
                        <TableCell>{index + 1}</TableCell>
                        <TableCell>{outsider.name || '_________________'}</TableCell>
                        <TableCell>{outsider.idNumber || '_________________'}</TableCell>
                        <TableCell>{outsider.purpose || '_________________'}</TableCell>
...
export default OutsidersPreview;
