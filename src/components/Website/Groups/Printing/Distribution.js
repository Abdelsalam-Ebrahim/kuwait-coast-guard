...
const printDistributionContent = (groupNumber = 'الأولى', distributionData = []) => {
  const tableHeaders = [
    'الرتبة',
    'المسمى الوظيفي',
    'الاسم الكامل',
  ...
  const finalDistributionData = distributionData.length > 0 ? distributionData : defaultDistributionData;
...
export default printDistributionContent;
