...
const MalfunctionCard = ({ malfunction }) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', gap: .2, flexWrap: 'wrap', justifyContent: 'space-between' }}>
        ...
        />
        <Chip
          label={`غير صالح: ${malfunction.notValid}`}
          size="small"
          sx={{
            backgroundColor: malfunction.notValid > 0
...
export default MalfunctionCard;
